            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'zuka-ai~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029VbAdr66545uqIbTkA82A) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [ZUKA-AI GitHub Repo](https://github.com/botdeveloper2026/ZUKA-AI)

🚀 _Thanks for choosing ZUKA-AI — Let the automation begin!_ ✨`;
